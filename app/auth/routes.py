...
auth_endpoints.add_url_rule(rule='/redirect/yahoo',
                            view_func=yahoo_redirect, methods=['GET'])
...
auth_endpoints.add_url_rule(rule='/callback/yahoo',
                            view_func=yahoo_callback, methods=['GET'])
